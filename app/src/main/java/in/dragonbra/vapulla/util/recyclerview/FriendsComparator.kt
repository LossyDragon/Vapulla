    ...
    override fun compare(o1: FriendListItem, o2: FriendListItem): Int {
        ...
        val (isRecent1, isRecent2) =
            when {
                recentsTimeout > 0 ->
                    Pair(
                        o1.lastMessageTime?.let { it >= updateTime - recentsTimeout } == true,
                        o2.lastMessageTime?.let { it >= updateTime - recentsTimeout } == true
                    )
                recentsTimeout == 0L -> Pair(o1.lastMessageTime != null, o2.lastMessageTime != null)
        ...
        return compareSortedNames(o1, o2)
    }
}
